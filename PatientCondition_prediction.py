...
dt=pd.read_csv("C:\\Users\\AlfredRomarioG\\OneDrive - Cittabase Solutions Private Limited\\Desktop\\Project\\healthcare_dataset.csv")
...
dt['medical_condition']=mc

tr=[]
for i in dt['test_results']:
    if i=='Inconclusive':
        tr.append((1))
    elif i=='Normal':
        tr.append((2))
...
if selected=="Prediction":
    ...
    dt=dt.drop(['doctor','hospital','insurance','room','admission_type','bill','name','date_of_admission',
